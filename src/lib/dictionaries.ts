...
export const dictionaries = {
  he: {
    ...
    contact: {
      ...
      ph: { name: "דוד לוי", email: "david@example.com", phone: "050-123-4567", message: "ספרו לנו על אתגרי הדאטה שלכם..." },
      submit: "שלח הודעה",
      reset: "נקה",
    },
    about: {
  ...
  en: {
    ...
    contact: {
      ...
      ph: { name: "David Levi", email: "david@example.com", phone: "+1 555-123-4567", message: "Tell us about your data challenges..." },
      submit: "Send message",
      reset: "Clear",
    },
    about: {
