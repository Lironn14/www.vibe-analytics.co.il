...
export const dictionaries = {
  he: {
    ...
    about: {
      ...
      bodyP1:
        "וייב אנליטיקס נוסדה על ידי לירון לוי, בעל תואר שני במנהל עסקים ובעלת 15 שנים בתחום המדידה הדיגיטלית והאנליטיקס. במהלך הקריירה שלו עבד עם ארגונים בכל הגדלים — מסטארטאפים צעירים ועד חברות אנטרפרייז — ולמד להבין את הצרכים העסקיים האמיתיים שמסתתרים מאחורי כל בקשת דאטה.",
      bodyP2:
      ...
      founderTag: "תואר שני במנהל עסקים · 15 שנים בתחום המדידה הדיגיטלית והאנליטיקס",
    },
    terms: {
      eyebrow: "מסמך משפטי",
      title: ["תקנון ", "האתר"],
